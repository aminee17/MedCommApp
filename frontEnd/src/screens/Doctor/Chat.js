...
const Chat = ({ route, navigation }) => {
    ...
    const handleSend = async () => {
        ...
        try {
            console.log('Sending message with data:', { formId, neurologistId, userId });
            
            // Send message to backend
            const messageData = {
                formId: formId,
                receiverId: neurologistId || null,  // Explicitly set to null if undefined
...
const styles = StyleSheet.create({
    ...
    medecinMessage: {
        backgroundColor: '#E3F2FD', // Light blue for doctor
        alignSelf: 'flex-end',
